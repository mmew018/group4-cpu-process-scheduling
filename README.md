...
## 🚀 วิธีการคอมไพล์และรันโปรแกรม (Quick Start)

### 1. คอมไพล์ไฟล์ Java ทั้งหมด
```bash
cd Group4_Queue
javac *.java
```

### 2. รันโปรแกรมหลัก (Scenario บังคับ P1–P4)
```bash
java Main
```

### 3. รันชุดทดสอบ 6 Test Cases
```bash
java SchedulerTest
```

### 4. รันการทดลองวัดประสิทธิภาพ (Benchmark)
```bash
java AlgorithmBenchmark
```

---

## 👥 สมาชิกผู้จัดทำ (Group 4)
* รายวิชา: Data Structures & Algorithms
* ภาคเรียน: ปฏิบัติการกลุ่ม Queue Algorithm Design & Analysis with Java
